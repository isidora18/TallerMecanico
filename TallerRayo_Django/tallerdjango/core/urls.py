...
from .views import index,agendar,cajasdecambio,clima,direccion,electronicaauto,formulario,geolocalizacion,inicioperfil,mantencion,perfiltrabajador,quienessomos,servicios,suspension,vehiculo
from django.conf import settings
from django.conf.urls.static import static

urlpatterns =[
    path('Index',index,name="Home")  + static(settings.STATIC_URL, document_root=settings.STATIC_ROOT),
